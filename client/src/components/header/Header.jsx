...
import { Container, Button, Text, Menu, MenuButton, MenuList, MenuItem, useDisclosure, Progress } from '@chakra-ui/react';
    ...
    return (
        <div>
            <Container marginTop="30px" maxW="container.xl" display="flex" justifyContent="space-between">
                <Text fontSize="lg" fontWeight="semibold">CH4T4PP</Text>
